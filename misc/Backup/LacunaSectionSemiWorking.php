		...
		<div id="topbar"> 
			...
			<div id="buttons">
				...
				<div id="select" title="Select" ><img src="imgs/select.png" ></img>  </div><div id="selectoptions">
					<div id="singleselect" title="Single Select"><img src="imgs/singleselect.png" ></img> </div>
			...
			function onMouseMove( event ) {
				...
				if ( helpertoggle == true ) {
					...
					if ( intersects.length > 0 ) {
						//console.log("Intersection ", intersects.length, intersects[0].object.parent);
						if ( (intersects[0].face != null) || (intersects[0].object == THREE.Line) ) {
							if ( SELECT ===  false ) {
								//console.log(intersects[0])
								//console.log(intersects[0], SELECT, intersects[0].object.parent instanceof THREE.Object3D);
								//$(document).keydown(function(e){ console.log("KEYPRESSED") });
								$(document).one('keydown', function (e) {
									//console.log(e);
									var code = e.keyCode || e.which;
									//console.log(code);
									if ( (String.fromCharCode(code) == "a") ||  (String.fromCharCode(code) == "A" ) ) {
										console.log("a")
												...
												//console.log(intersectedObject)
												 if (aObject3D === true) {
													...
													intersectedObject.children.forEach( function(child) {
														colorArray.push(child.material.color.getHex());
													...
													SELECTED.color.push(colorArray)
													...
													SELECTED.color.push(intersectedMesh.material.color.getHex)
											...
											if (inSelected  != -1) {
												...
												if (aObject3D === true) {
													intersectedObject.children.forEach( function(child, colIndex) {
														...
														child.material.color.setHex( SELECTED.color[inSelected][colIndex] )
														child.material.ambient.setHex( SELECTED.color[inSelected][colIndex] )
												...
												else if ((aLineObject === true || aMeshObject === true) && (intersectedMesh.object.name != "Helper")) {
													
													intersectedMesh.material.color.setHex( SELECTED.color[inSelected][1] )
													SELECTED.sceneobject.splice(inSelected, 1);
													SELECTED.color.splice(inSelected, 1);
