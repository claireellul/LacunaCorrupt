	...
	<body>
		...
		<script>
			...
			function init() {
				...
				var EPSILON = 0.0001 // 1 meter - 0.1 decimeter 0.01 - centimeter 0.001 milimeter
				...
				function loadLayer(layername) {
					...
					if (aLayer[1][0] == "POLYHEDRALSURFACE Z" && aLayer[1][1] != null) {
						...
						aLayerArray.forEach( function(aFeature) {
							...
							polyhedralzGroup.name = id.toString();
							console.log("Adding polyhedralzGroup");
				...
				//scene.children.forEach(function(x) { console.log(x)});
